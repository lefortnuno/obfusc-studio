...
<RequestRow> 
    ...
    <ReconciliationAccountSuffix><xsl:value-of select="normalize-space(substring($record, 272, 2))"/></ReconciliationAccountSuffix> 
    ...
    <FileReferencec>@FileReferencec</FileReferencec> 
